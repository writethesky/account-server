...
func cors(c *gin.Context) {
	...
	c.Writer.Header().Set("Access-Control-Allow-Headers", "Content-Type, Content-Length, Accept-Encoding, Authorization, Security, accept, origin, Cache-Control, Request-ID, X-Requested-With")
